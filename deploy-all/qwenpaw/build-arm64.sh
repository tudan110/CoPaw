...
# 在 amd64 主机上跑 arm64 镜像依赖 binfmt/QEMU；buildx --load 能产出该镜像即说明
# binfmt 已就绪，docker run 同样可经模拟执行。
...
echo ""
echo "💡 导出镜像："
echo "docker save -o qwenpaw-arm64.tar $IMAGE_NAME:$TAG"
echo ""
echo "💡 在目标设备上加载镜像："
echo "docker load -i qwenpaw-arm64.tar"
