...
示例:
  ...
  uv run analyze_alarms.py --mode summary --begin_time "2026-03-15 10:00:00" --end_time "2026-03-16 10:00:00"
    ...
    parser.add_argument("--keyword_field", type=str, default="all",
                        help="关键字搜索字段，默认 all")
    ...
    parser.add_argument("--cities", type=str, nargs="+", required=False,
                        help="城市列表，如：南京 秦淮区")
    parser.add_argument("--fetch_page_size", type=int, default=100,
                        help="抓取全量告警时的分页大小，默认 100")
    parser.add_argument("--top_n", type=int, default=10,
                        help="分组结果或预览告警数量，默认 10")
    parser.add_argument("--include-alarms", action="store_true",
                        help="输出完整告警预览列表")
