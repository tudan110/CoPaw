...
export const digitalEmployees: DigitalEmployee[] = [
  {
    ...
    welcome:
      "您好！我是数据分析员。统一查询、告警统计与报表生成。<br><br>我可以帮您完成以下工作：<br>• 指标查询 - 自然语言查询各类监控指标<br>• 实时告警查询 - 查询数据库、网络设备、中间件、操作系统、服务器等当前告警<br>• 告警统计 - 按级别、设备、类型、区域生成统计和图表<br>• 报表生成 - 自动生成日报、周报、月报<br>• 数据可视化 - 生成直观的图表和仪表盘<br><br>请直接输入您的查询需求，或选择下方的快捷命令。",
  },
  {
    id: "fault",
    name: "故障分析员",
  ...
  },
  {
    ...
    welcome:
      "您好！我是工单调度员。工单处理与流程自动化。<br><br>我可以帮您完成以下工作：<br>• 工单创建 - 根据故障或变更需求自动开单<br>• 智能分派 - 按归属、技能、负载自动指派处理人<br>• 处理跟踪 - 监控工单状态，超时自动升级<br>• 自动关闭 - 工单完成后自动核销并联动相关系统<br>• 统计报表 - 按时间、类型、处理人生成工单台账与日/周/月报<br>• 工单导出 - 导出工单查询列表为 Excel 等格式<br><br>请直接输入您的工单需求，或选择下方的快捷命令。",
  },
  {
    id: "knowledge",
    name: "知识专员",
