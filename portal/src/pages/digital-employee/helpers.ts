...
export const PORTAL_ADVANCED_PANEL_OPTIONS = ["model-config", "settings", "token-usage", "ops-expert", "mcp", "skill-pool", "fde-workbench", "knowledge-base", "inspiration", "cli", "resource-import"] as const;
