...
export const PORTAL_ADVANCED_PANEL_OPTIONS = ["model-config", "token-usage", "ops-expert", "mcp", "skill-pool", "fde-workbench", "knowledge-base", "inspiration", "resource-import", "nl-customization", "app-market", "cli", "settings"] as const;
